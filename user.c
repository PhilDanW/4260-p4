...
//user.c contains the user process which will accept a message that gives a process a time slice 
//of the processor. It will only return a message to oss the how much time the process took to complete
